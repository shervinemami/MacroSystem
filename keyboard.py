...
letterMap = {
    ...
    "(zachman) ": "z",     # zirconium? zircumference? zosepi? zidacious is like shift, zultani is like up home, zood is like undo and rude, zooki? zyxel is like click, zooch & zener are like insert! zulu, zoolex, zolex & zook often aren't getting picked up! "zed" is like "said" and "set"
}
