...
letterMap = {
    ...
    "(bernie) ": "b",        #  burn is like end, brain is like queen, brayo is like premier, "brown" is like down. "black" is like "ebike", "best" sometimes gets picked up as "this" or "guess". "B|the" sometimes gets picked up as "enter"
    "(char) ": "c",
