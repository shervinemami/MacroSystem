...
# Careful of any word that sounds similar to up, 8, 1, 2, and Dragon keywords "spell", "click", "select", "correct that", "exit dragon"!
...
letterMap = {
    ...
    "(newish) ": "n",   # newish sometimes isn't heard. noosh is maybe like mosfet. niche is like unix. # nose?  "Nippy" is like "up"
    ...
    "(zoobkoiy) ": "z",     # zoobkoi is a bit like "close window"! zirconium? zircumference? zosepi? zidacious is like shift, zultani is like up home, zood is like undo and rude, zooki? zyxel is like click, zooch & zener are like insert! zulu, zoolex, zolex, zook and zeakbajived often aren't getting picked up! "zed" is like "said" and "set"
}
