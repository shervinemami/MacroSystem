# Careful of any word that sounds similar to up, 8, 1, 2, and
# also Dragon keywords "spell", "click", "select", "correct that", "read that", "close window", "make command", "exit dragon"!
