...
class ProgramsRule(MappingRule):
    mapping = {
        ...
        "change to left tab [<n> times]":           Key("ctrl:down/3, win:down/3, alt:down/3, shift:down/3, l/3:%(n)d/3") + Key("ctrl:up/3, win:up/3, alt:up/3, shift:up/3"),
        "change to right tab [<n> times]":          Key("ctrl:down/3, win:down/3, alt:down/3, shift:down/3, r/3:%(n)d/3") + Key("ctrl:up/3, win:up/3, alt:up/3, shift:up/3"),
