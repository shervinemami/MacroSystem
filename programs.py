...
class ProgramsRule(MappingRule):
    mapping = {
        ...
        "change to left tab [<n> times]":           Key("ctrl:down/3, win:down/3, alt:down/3, shift:down/3, l/3:%(n)d/3") + Key("ctrl:up, win:up, alt:up, shift:up"),
        "change to right tab [<n> times]":          Key("ctrl:down/3, win:down/3, alt:down/3, shift:down/3, r/3:%(n)d/3") + Key("ctrl:up, win:up, alt:up, shift:up"),
